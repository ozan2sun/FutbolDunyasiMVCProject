...
namespace FutbolDunyasi.Controllers
{
    public class TakimlarController : Controller
    {
        ...
        public TakimlarController(UygulamaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Takimlar != null ? 
                          ...
                          Problem("Entity set 'UygulamaDbContext.Takimlar'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad")] Takim takim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad")] Takim takim)
        {
            if (id != takim.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UygulamaDbContext.Takimlar'  is null.");
            }
            var takim = await _context.Takimlar.FindAsync(id);
            if (takim != null)
            {
